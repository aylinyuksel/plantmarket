...
def user_direvtory_path(instance, filename):
...
class Vendor(models.Model):
    ...
    shipping = models.CharField(max_length=100, default="100")
...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to=user_direvtory_path, default="product.jpg")
...
class ProductImages(models.Model):
    images = models.ImageField(upload_to=u"product-images", default="product.jpg")
...
class CartOrderItems(models.Model):
    ...
    qty = models.IntegerField(default=0) #quantity
    price = models.DecimalField(max_digits=999999999999, decimal_places=2, default=1.99)
